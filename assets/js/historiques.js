...
function CancelAppointment(id) {
    ...
    //if (isConfirmed) {
        Swal.fire({
            ...
            <p>
                <strong>⚠️ Ce rendez-vous est dans moins de 48 heures.
                Il est peu probable qu'il soit réservé par un autre patient.</strong>
                Par respect pour votre praticien, n’annulez qu’en cas de nécessité absolue.
        ...
        `,
            ...
            confirmButtonColor: '#31aa8d',
            cancelButtonColor: '#fe1e66',
            confirmButtonText: 'Oui, annuler',
            cancelButtonText: 'Non, conserver'
        }).then((result) => {
            if (result.isConfirmed) {
             sessionStorage.setItem("appid" ,id)   
             window.location.href="./annuler-rendez-vous.html"
    }
})
}
